...
export function ProductCarousel({ slides }: ImageCarouselProps) {
  ...
  return (
      <div className="flex flex-col-reverse md:flex-row max-md:justify-center gap-3">
        <div className="flex max-md:mx-5 max-h-[384px] flex-shrink-0 md:flex-col gap-1 rounded-md md:overflow-x-hidden scrollbar-hidden overflow-y-auto">
        ...
        <div className="w-full max-sm:px-2 flex justify-center">
